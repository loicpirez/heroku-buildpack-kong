...
=========================
Deploy [Kong 0.13 Community Edition](https://konghq.com/kong-community-edition/) as a Heroku app.
...
#### Plugins & other Lua source
  ...
  * [Kong plugins](https://getkong.org/plugins/)
    * [Development guide](https://getkong.org/docs/0.13.x/plugin-development/)
    * `lib/kong/plugins/{NAME}`
    * Add each Kong plugin name to the `custom_plugins` comma-separated list in `config/kong.conf.etlua`
    * See: [Plugin File Structure](https://getkong.org/docs/0.13.x/plugin-development/file-structure/)
  * Lua rocks
...
Kong is an Nginx-based application. To customize the underlying Nginx configuration, commit the file `config/nginx.template` with contents based on [the docs](https://getkong.org/docs/0.13.x/configuration/#custom-nginx-configuration) or [this included sample](config/nginx.template.sample).
...
Tests should follow the [Kong plugin testing](https://getkong.org/docs/0.13.x/plugin-development/tests/) guide.
